...
<template>
  <section
    id="map"
    data-page-section
    class="yandex-studio-map grid min-h-full bg-white pb-[var(--page-content-safe-bottom,3.75rem)] text-ink desktop:grid-cols-[minmax(17rem,0.38fr)_minmax(0,1fr)]"
  >
    ...
    <div class="relative min-h-[22rem] bg-page desktop:min-h-0">
      ...
      <p class="pointer-events-none absolute top-5 right-5 bg-white/90 px-3 py-2 text-[0.625rem] font-bold tracking-[0.14em] text-ink uppercase backdrop-blur-sm">
        Яндекс Карты
      </p>
    </div>
  </section>
